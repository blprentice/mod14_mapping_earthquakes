...
let _earthquakes = new L.layerGroup();
...
d3.json(earthquakes).then(function(data) {
  ...
  L.geoJSON(data, {
    ...
    // We set the style for ech circleMarker using our styleInfo function.
    style: styleInfo,
    // We create a popup for ech circleMarker to displa the magnitude and
